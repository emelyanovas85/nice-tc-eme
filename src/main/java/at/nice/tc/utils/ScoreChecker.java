...
public class ScoreChecker {
    ...
    public static void compareWithReference(String jsonArray, String keyTestCase) {
        ...
        (List < Map < String, Object >> actual, List < Map < String, Object >> expected, String testKey){
            ...
            for (String key : expected.keySet()) {
                ...
                if (expVal instanceof List<?> expList && actVal instanceof List<?> actList) {
                    ...
                    for (int i = 0; i < expList.size(); i++) {
                        ...
                        if (!(actItem instanceof Map) || !(expItem instanceof Map)) {
                            continue; // Пропускаем String/числа
                        }
